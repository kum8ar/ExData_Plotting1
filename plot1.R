...
# Code for Plot1 function

plot1 <- function() {
  hist(household_power_consumption1$Global_active_power, main = paste("Global Active Power"), col="red", xlab="Global Active Power (kilowatts)")
